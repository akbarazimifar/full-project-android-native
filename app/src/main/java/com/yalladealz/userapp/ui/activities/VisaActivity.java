...
public class VisaActivity extends AppCompatActivity {
    ...
    private VisaViewModel viewModel;
    private int money;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            money = bundle.getInt("money", 0) * 100;
...
//        boolean isShipping = getIntent().getBooleanExtra("shipping", false);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (extras != null) {
            debug("extras: " + extras.toString());
            if (extras.getString(PayResponseKeys.PENDING).equals("false")
                    && extras.getString(PayResponseKeys.SUCCESS).equals("true")) {
                // TODO: 15/09/19 Transiction successfull, show coupon

                debug("done");
                Toast.makeText(this, extras.getString(PayResponseKeys.DATA_MESSAGE), Toast.LENGTH_SHORT).show();
...
//                .navigate(R.id.action_visaActivity_to_cartFragment);
